  ...
  void block_powerit_PRECISION_init_and_alloc( int spec_type, int op_id, int depth_bp_op_PRECISION, int nr_vecs, int nr_bpi_cycles, double bp_tol, level_struct* l, struct Thread* threading );
  void block_powerit_PRECISION_free( level_struct* l, struct Thread* threading );
  void block_powerit_PRECISION( int op_id, int depth_bp_op_PRECISION, level_struct *l, struct Thread* threading );
  void blind_bp_op_PRECISION_PRECISION_apply( op_id, lx, threading );
