...
printf("Solving with..... \t %e\n", g.trace_powerit_solver_tol[l->depth]);
 ...
 //Restrict. Prolongate, I-ant, Solve, R, P, I- ant 

  apply_R_PRECISION( l->powerit.vecs_buff1, l->powerit.vecs[i], l, threading );
  apply_P_PRECISION( l->powerit.vecs_buff2, l->powerit.vecs_buff1, l, threading );
  vector_PRECISION_minus(  p->b, l->powerit.vecs[i], l->powerit.vecs_buff2, start, end, l );
  apply_solver_powerit_PRECISION( l, threading );
  apply_R_PRECISION( l->powerit.vecs_buff1, p->x, l, threading );
  apply_P_PRECISION( l->powerit.vecs_buff2, l->powerit.vecs_buff1, l, threading );
  vector_PRECISION_minus(  l->powerit.vecs[i], l->powerit.vecs[i], l->powerit.vecs_buff2, start, end, l );
